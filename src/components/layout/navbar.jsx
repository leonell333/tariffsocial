...
import {searchPostsByKeywords, updatePostStore} from '../../store/actions/postActions'
import {getUnreadCounts, updateBaseStore} from '../../store/actions/baseActions'

const CreateAdvertisement = lazy(() => import('../../pages/advertise'))
                ...
                `}
                        ...
                        <div className="flex items-center w-max flex-none lg:w-[300px] advertise-on-menu gap-4">
                            ...
                            >
                                ...
                                <Box>
                                    <img src={logo} className="h-[40px] mt-[6px]"
