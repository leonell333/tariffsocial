...
import {getCampaigns, handlePaymentSession, renewCampaign} from "../../store/actions/advertiseAction";
      ...
      <div className="w-full min-h-[calc(100vh-170px)] border border-[#EBEBEB] rounded-xl bg-white">
        ...
        <div className="responsive-table-wrapper">
          <TableContainer
            component={Paper}
            elevation={0}
            sx={{ overflowX: "auto", p: "10px", maxWidth: "100%", }}
          >
            <Table
              sx={{
            ...
            >
              <TableHead>
                <TableRow>
                  <TableCell
                    sx={{ width: "2%", textOverflow: "ellipsis", p: 1 }}
                    align="left"
                  >
                    ID
                  </TableCell>
                  <TableCell
                    sx={{ width: "17%", textOverflow: "ellipsis", p: 1 }}
                    align="left"
                  >
                    Description
                  </TableCell>
                  <TableCell
                    sx={{ width: "10%", textOverflow: "ellipsis", p: 1 }}
                    align="left"
                  >
                    Category
                  </TableCell>
                  <TableCell
                    sx={{ width: "16%", textOverflow: "ellipsis", p: 1 }}
                    align="left"
                  >
                    Link
                  </TableCell>
                  <TableCell
                    sx={{ width: "8%", textOverflow: "ellipsis", p: 1 }}
                    align="left"
                  >
                    Image
                  </TableCell>
                  <TableCell
                    sx={{ width: "6%", textOverflow: "ellipsis", p: 1 }}
                    align="left"
                  >
                    Country
                  </TableCell>
                  <TableCell
                    ...
                    align="left"
                  >
                    <Tooltip title="Publish Date" arrow>
                      Date
                    </Tooltip>
                  </TableCell>
                  <TableCell
                  ...
                  <TableCell
                    sx={{ width: "5%", textOverflow: "ellipsis", p: 1 }}
                    align="left"
                  >
                    Days
                  </TableCell>
                ...
                {campaigns.map((item, index) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell sx={{ width: "10%", p: 1 }}>
                      <Tooltip
                        title={item.type === "ads" ? "Banner" : "Sponsored"}
                        arrow
                      >
                        <div className="table-cell-ellipsis">
                    ...
                    <TableCell sx={{ width: "8%", p: 1 }}>
                      <Tooltip
                        title={String(item.budget * item.days || 0)}
                        arrow
                      >
                        <div className="table-cell-ellipsis">
                    ...
                    <TableCell sx={{ width: "5%", p: 1 }}>
                      <Tooltip
                        title={item.billed ? "Billed" : "UnBilled"}
                        arrow
                      >
                        <div className="table-cell-none-ellipsis">
                    ...
                    <TableCell sx={{ width: "5%", p: 1 }}>
                      {!item.billed && (
                        <div
                          onClick={() =>
                            navigate(`/payment?id=${item.id}&type=${item.type}`)
                          }
